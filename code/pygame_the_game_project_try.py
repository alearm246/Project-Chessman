...
class Player(Character):
    ...
    def update(self): # moves the Player
        ...
        self.check_boundary()
        self.is_touching(self.world.enemy)
        self.lives_removed(self.world.enemy)
        self.lives_removed(self.world.enemy2)
        self.kill(self.world.enemy)
        self.is_touching(self.world.enemy2)
        self.Interacting(self.world.npc)
...
class World:
    ...
    def change_location(self, background_image):
        ...
        self.enemy = Enemy(self,100, 100, )
        self.npc = NonPlayer(self, surface.blit(npc, (0,0))
        self.enemy2 = Enemy(self,200, 200)
...
class App:
    def __init__(self):
        ...
        enemy1 = pygame.image.load('assets/bad_face_12x12.png')
        npc = pygame.image.load('assets/npc_32x32.png')
        enemy2 = pygame.image.load('assets/bad_face_12x12.png')
